...
import { THUMNAIL_HERO } from "@/constants/images";
  ...
  return (
    <section className="w-full">
      <div className="max-w-screen-1.5xl mx-auto w-full px-4 md:px-16 lg:px-16 xl:px-28 py-10 md:py-14 lg:py-16 flex flex-col lg:flex-row items-start lg:items-center justify-center gap-6 md:gap-10 xl:gap-14">
        {/* LEFT SIDE */}
        <div className="w-full lg:w-1/2 flex flex-col gap-5 lg:gap-6 xl:gap-9 items-center">
          <h1 className="font-extrabold text-2.5xl lg:3xl xl:text-4.5xl">
            Transform your website into a sales magnet using{" "}
            <span className="lg:hidden gradient-text">
              No missed calls, Just results.
            </span>
            <span className="hidden lg:block gradient-text mt-1">
              AI Call & Chat Assistants.
            </span>
          </h1>
        ...
        <div className="w-full lg:w-1/2 h-full flex items-center justify-center">
          <Image
            ...
            srcSet={`${THUMNAIL_HERO}?w=192 192w,
                    ${THUMNAIL_HERO}?w=384 384w,
                    ${THUMNAIL_HERO}?w=768 768w`}
          />
        ...
        <div className="flex lg:hidden flex-col items-center lg:items-start justify-center gap-3 lg:gap-4 w-full px-4 lg:px-0">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-3 w-full h-full">
            <input
              type="email"
              name="email"
              id="email"
